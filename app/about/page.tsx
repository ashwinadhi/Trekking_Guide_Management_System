  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-28 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-4 bg-gold/10 text-gold">Meet Your Guide</Badge>
              <h1 className="text-4xl md:text-5xl font-bold text-ivory mb-6">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-card p-6 rounded-lg shadow-lg max-w-xs">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-bold text-ivory">Licensed Guide</span>
                </div>
                <p className="text-sm text-stone">Nepal Tourism Board #NTB-2024-456</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-ivory mb-4">My Journey to Becoming Your Guide</h2>
          </div>

          <div className="prose prose-lg max-w-none">
            <div className="bg-background p-8 rounded-lg mb-8">
              <h3 className="text-2xl font-bold text-ivory mb-4">From Local Boy to International Guide</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <Card className="p-6">
                <h4 className="text-xl font-bold text-ivory mb-3">Languages I Speak</h4>
              ...
              <Card className="p-6">
                <h4 className="text-xl font-bold text-ivory mb-3">My Specialties</h4>
                <ul className="space-y-2 text-ivory">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-ivory mb-4">Credentials & Certifications</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 text-center">
              ...
              <p className="text-stone mb-3">Nepal Tourism Board Official License</p>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-stone mb-3">Wilderness First Aid & CPR Training</p>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-stone mb-3">Advanced Mountain Safety Course</p>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-stone mb-3">UNESCO World Heritage Sites Specialist</p>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-stone mb-3">Sustainable Tourism Practices</p>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-stone mb-3">Expert in 25+ Trekking Routes</p>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-ivory mb-8">My Guiding Philosophy</h2>

          <div className="bg-gold/5 p-8 rounded-lg mb-8">
            <blockquote className="text-2xl font-medium text-ivory mb-6">
            ...
            <cite className="text-lg text-gold font-semibold">- Ashwin, Your Trekking Guide</cite>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            <div>
              <h3 className="text-xl font-bold text-ivory mb-3">Safety First</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-ivory mb-3">Cultural Bridge</h3>
              <p className="text-stone">
            ...
            <div>
              <h3 className="text-xl font-bold text-ivory mb-3">Personal Touch</h3>
              <p className="text-stone">
      ...
      <section className="py-20 bg-gold text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button size="lg" className="bg-card text-gold hover:bg-secondary">
                Get in Touch
              </Button>
            </Link>
            <Link href="/treks">
              <Button
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-card hover:text-gold bg-transparent"
              >
                View Trek Packages
              </Button>
            </Link>
